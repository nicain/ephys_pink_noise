...
def main():
    ...
    app_path = os.path.expanduser('~') + '/ephys_pink_noise'
    ...
    create_shortcut('ephys_pink_noise', os.path.expanduser('~') + '/Desktop')
    create_shortcut('ephys_pink_noise_uninstall', os.path.expanduser('~'))
