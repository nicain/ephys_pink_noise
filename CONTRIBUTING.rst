...
ephys_pink_noise documentation should always be contributed in the form of docstrings, user guide or
examples.
...
Setting up ephys_pink_noise `cookiecutter-pypackage` for local development.
